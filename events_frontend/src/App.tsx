  ...
  return (
    <div className="App">
      <header className="App-header">      
        <h1><img src="/logo/decentered.png" />Decentered Eventracker</h1>
        <div className="linkAndExplanation">A curated list of Bay Area events to create an interconnected art scene </div>
        <div className="linkAndExplanation">By <a className="spreadsheetLink" href="https://decenteredarts.org" target="_blank">Decentered Arts</a></div>
        <div className="subLinks"><a className="spreadsheetLink" href={SUBMIT_URL} target="_blank">Submit an event</a> | <a className="spreadsheetLink" href={DONATE_LINK} target="_blank">Donate</a></div>
      ...
      <div className="copyright">Events imported from <a href={SPREADSHEET_URL} target="_blank" className="spreadsheetLink">the Decentered Eventracker spreadsheet</a><br />Decentered Arts<br />{new Date().getFullYear()}</div>
      <div className="socialPlus"><SocialLinks /><div>hello@decentered.org</div></div>
      </div>
      </footer>
    </div>
  );
